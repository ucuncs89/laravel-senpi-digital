            ...
            <div class="col-md-12 col-lg-12">
                <div class="row row-cols-1">
                    <div class="d-slider1 overflow-hidden">
                        <ul class="swiper-wrapper list-inline m-0 mb-2 p-0">
                        ...
                        <div class="card" data-aos="fade-up" data-aos-delay="800">
                            <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
                                ...
                                <div class="d-flex align-items-center align-self-center">
                                    ...
                                    <div class="d-flex align-items-center text-info ms-3">
                                        <svg class="icon-12" xmlns="http://www.w3.org/2000/svg" width="12"
                                            viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    ...
                                    <div class="d-grid gap col-md-4 col-lg-4">
                                        <div class="d-flex align-items-start">
                                            <svg class="icon-14 mt-2" xmlns="http://www.w3.org/2000/svg" width="14"
                        ...
                        <div class="card overflow-hidden" data-aos="fade-up" data-aos-delay="600">
                            <div class="card-header d-flex justify-content-between flex-wrap">
                                <div class="header-title">
                                    ...
                                    <p class="mb-0">
                                        <svg class="text-primary icon-24 me-2" width="24" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img class="bg-soft-primary img-fluid avatar-40 me-3 rounded"
                                                ...
                                                <td>
                                                    ...
                                                    <div class="progress bg-soft-primary w-100 shadow-none"
                                                        style="height: 4px">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="progress bg-soft-success w-100 shadow-none"
                                                        style="height: 4px">
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card credit-card-widget" data-aos="fade-up" data-aos-delay="900">
                            <div class="card-header border-0 pb-4">
                                <div class="primary-gradient-card rounded border border-white p-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-itmes-center justify-content-between mb-4 flex-wrap">
                                    <div class="d-flex align-itmes-center me-md-4 me-0">
                                        <div>
                                            <div class="bg-soft-primary mb-2 rounded p-3">
                                    ...
                                    <div class="d-flex align-itmes-center">
                                        <div>
                                            <div class="bg-soft-info mb-2 rounded p-3">
                                                <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="card" data-aos="fade-up" data-aos-delay="500">
                            <div class="card-body d-flex justify-content-around text-center">
                                <div>
                                    ...
                                    <p class="text-gray mb-0">Website Visitors</p>
                                </div>
                                <hr class="hr-vertial" />
                                <div>
                                    <h2 class="mb-2">7,500</h2>
                                    <p class="text-gray mb-0">New Customers</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card" data-aos="fade-up" data-aos-delay="600">
                            <div class="card-header d-flex justify-content-between flex-wrap">
                                <div class="header-title">
                                    ...
                                    <p class="mb-0">
                                        <svg class="icon-24 me-2" width="24" height="24" viewBox="0 0 24 24">
                                            <path fill="#17904b"
