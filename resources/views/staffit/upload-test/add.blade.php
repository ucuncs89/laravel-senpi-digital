        ...
        <div class="section-content">
            ...
            <form>
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="nama-test" name="nama-test" placeholder="Masukan Nama Test" required>
                </div>

                <div class="mb-3">
                    <label for="personil" class="form-label">Personil<span style="color: red">*</span></label>
                    <input class="form-control" type="text" id="personil" name="personil" placeholder="Masukan Personil" required>
                </div>
